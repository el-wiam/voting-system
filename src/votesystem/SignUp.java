...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/logoooooo-removebg-preview.png"))); // NOI18N
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        String fullName, email,usernam , Password, query;
        ...
        try {
            ...
            query = "INSERT INTO voters(full_name, email,username, password)"+
                    "VALUES('"+fullName+"', '"+email+"' , '"+usernam+"' , '"+Password+"')";
